...
try:
    with Session() as session:  # Usando a sessão corretamente
        fornecedores = [
            Fornecedor(
                nome="Fornecedor A",
                telefone="12345678",
...
# Supondo que engine já foi definido anteriormente e os modelos
# Produto e Fornecedor foram definidos conforme o exemplo anterior.
session = Session()
